          ...
          {services.map((service) => {
            ...
            return (
              <Link
                ...
                className={`group relative p-6 md:p-8 rounded-3xl transition-all duration-500 cursor-pointer transform hover:scale-105 block ${
                  isActive
              ...
              >
                ...
                {/* Title */}
                <h3 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-pink-500 group-hover:to-blue-600 transition-all duration-300">
                  {service.title}
                </h3>
                ...
                <div className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-full transition-all duration-300 bg-gradient-to-r from-pink-500 to-blue-600 text-white group-hover:shadow-lg">
